...
from augmentors import ScaleAug, RotateAug, CropAug, FlipAug,joints_to_point8, point8_to_joints, AugImgMetadata
from dataflow import CocoDataFlow, JointsLoader
from label_maps import create_heatmap
...
def get_dataflow(annot_path, img_dir):
    ...
    """
    df = CocoDataFlow((480, 480), annot_path, img_dir)
    df.prepare()
