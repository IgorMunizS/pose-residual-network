...
def parse_args(args):
    ...
    coco_parser.add_argument('coco_path', help='Path to dataset directory (ie. /tmp/COCO).', default='/tmp/COCO')
...
def main(args=None):
    ...
    if 'vgg' in args.backbone or 'densenet' in args.backbone or 'squeezenet' in args.backbone:
